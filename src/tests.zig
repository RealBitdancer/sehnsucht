...
//
// Only modules that declare tests are listed. `_ = @import("player.zig")`
// analyzes only that file's own declarations, never its imports, so a module
// missing here does not fail the build, it just stops being tested.
